...
public record Attribute(int Permanent, int Min = -10, int Max = 10)
{
...
public record Attributes(
    ...
    Attribute Vitality)
{
    public static readonly Attributes Empty = new(
    ...
    /// </summary>
    public Attributes ApplyModifier(AttributesModifier mod) => new(
        new Attribute(Musculature.Permanent + RandomBounded(mod.Musculature)),
        new Attribute(Flexibility.Permanent + RandomBounded(mod.Flexibility)),
        new Attribute(Brain.Permanent + RandomBounded(mod.Brain)),
        new Attribute(Vitality.Permanent + RandomBounded(mod.Vitality)));

    /// <summary>Applique un modificateur fixe (sans aléatoire).</summary>
    public Attributes ApplyFixed(AttributesModifier mod) => new(
        new Attribute(Musculature.Permanent + mod.Musculature),
        new Attribute(Flexibility.Permanent + mod.Flexibility),
        new Attribute(Brain.Permanent + mod.Brain),
        new Attribute(Vitality.Permanent + mod.Vitality));
